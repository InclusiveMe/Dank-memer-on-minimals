...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        let Embed = new MessageEmbed()
            .setColor("GREEN")
            .setDescription(`<a:wrong:908686422184198184> You need 200 coins to purchase Bronze VIP`);
        ...
        if (args.join(' ').toLocaleLowerCase() == 'bronze') {
            ...
            let Embed2 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:WA_Money_Moving:918469335821987850> Purchased Bronze VIP For 200 Coins`);
            ...
            let Embed3 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:wrong:908686422184198184> You need 600 coins to purchase some Nikes`);
            ...
            let Embed4 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:WA_Money_Moving:918469335821987850> Purchased Fresh Nikes For 600 Coins`);
            ...
            let Embed5 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:wrong:908686422184198184> You need 800 coins to purchase a new car`);
            ...
            let Embed6 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:WA_Money_Moving:918469335821987850> Purchased A New Car For 800 Coins`);
            ...
            let Embed7 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:wrong:908686422184198184>You need 1200 coins to purchase a Mansion`);
            ...
            let Embed8 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:WA_Money_Moving:918469335821987850> Purchased A Mansion For 1200 Coins`);
            ...
            if (message.content.toLowerCase() === `${prefix}buy`) {
                let embed9 = new MessageEmbed()
                    .setColor("GREEN")
                    .setDescription(`<a:wrong:908686422184198184> Enter An Item To Buy!\nType ${prefix}store To See List Of Items!`)
            ...
            let Embed3 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:wrong:908686422184198184> You need 1500 coins to purchase some custom role`);
            ...
            let Embed4 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:WA_Money_Moving:918469335821987850> I already added your custom role, ask an admin to give you the role`);
