    ...
    run: async (bot, message, args) => {
        ...
        if (args.join(' ').toLocaleLowerCase() == 'nikes') {
            let embed1 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:wrong:908686422184198184> You don't have Nikes to sell`);
            ...
            let embed2 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:WA_Money_Moving:918469335821987850> Sold Fresh Nikes For 600 Coins`);
            ...
            let embed3 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:wrong:908686422184198184> You don't have a Car to sell`);
            ...
            let embed4= new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:WA_Money_Moving:918469335821987850> Sold a Car For 800 Coins`);
            ...
            let sembed2 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<:Cross:918322890322087996> You don't have a Mansion to sell`);
            ...
            let sembed3 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:WA_Money_Moving:918469335821987850> Sold a Mansion For 1200 Coins`);
            ...
            if (message.content.toLowerCase() === `${prefix}sell`) {
                let embed9 = new MessageEmbed()
                    .setColor("GREEN")
                    .setDescription(`<:Cross:918322890322087996> Enter an item to sell. Type ${prefix}store to see list of items`)
