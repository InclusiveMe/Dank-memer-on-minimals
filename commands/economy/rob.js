...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    let embed2 = new MessageEmbed()
      .setColor("GREEN")
      .setDescription(`<a:wrong:908686422184198184> You cannot rob yourself`)
    ...
    if (author !== null && timeout - (Date.now() - author) > 0) {
      ...
      let timeEmbed = new MessageEmbed()
        .setColor("GREEN")
        .setDescription(`<:Cross:918322890322087996> You have already robbed someone\n\nTry again in ${time.minutes}m ${time.seconds}s `);
      message.channel.send(timeEmbed)
    } else {

      let moneyEmbed = new MessageEmbed()
        .setColor("GREEN")
        .setDescription(`<:Cross:918322890322087996> You need atleast 100 coins in your wallet to rob someone`);
      ...
      let moneyEmbed2 = new MessageEmbed()
        .setColor("GREEN")
        .setDescription(`<:Cross:918322890322087996> ${user.user.username} does not have anything you can rob`);
      ...
      if (targetuser < random) {
        ...
        let embed = new MessageEmbed()
          .setDescription(`<a:WA_Money_Moving:918469335821987850> You robbed ${user.user.username} and got away with ${random} coins`)
          .setColor("GREEN")
